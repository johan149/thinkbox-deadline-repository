...
RUN ./DeadlineRepository-10.1.0.12-linux-x64-installer.run \
    --unattendedmodeui none --mode unattended --prefix /opt/Thinkbox/DeadlineRepository10/ --setpermissions true --installmongodb true --dbOverwrite true --prepackagedDB ./mongodb-linux-x86_64-debian81-3.2.18.tgz --dbInstallationType prepackagedDB --mongodir /opt/Thinkbox/DeadlineDatabase10/ --dbListeningPort 27100 \
