...
RUN mkdir /Applications/Thinkbox/DeadlineDatabase10/
...
RUN ./DeadlineRepository-10.1.0.12-linux-x64-installer.run \
    --unattendedmodeui none --mode unattended --prefix /opt/Thinkbox/DeadlineRepository10/ --setpermissions true --installmongodb true --dbOverwrite true --dbInstallationType downloadDB --mongodir /Applications/Thinkbox/DeadlineDatabase10 --dbListeningPort 27100 \
